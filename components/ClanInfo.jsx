...
function LeaderCard({ leader }) {
    return (
        <>
            <Card className="w-[350px] bg-[#463067] border-4 border-solid border-yellow-200 rounded-2xl p-6 transition-transform hover:scale-105">
                <CardContent>
                    <div className="w-full p-4">
                        <section>
                            <div className="col-span-3">
                                <div className="mt-6 relative h-60 flex justify-center items-center">
                                    <Image
                                        src={leader.imageSrc}
